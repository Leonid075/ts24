...
n = ["age", "Medu", "Fedu", "traveltime", "studytime", "failures", "famrel",
     "freetime", "goout", "Dalc", "Walc", "health", "absences", "G1", "G2", "G3"]
srt = ["Mjob", "Fjob", "reason", "guardian", "romantic", "cheating", "school", "sex", "address", "famsize",
...
print(p5/(4*len(dataor[dataor["Subject"] == "Por"])),
      m5/(4*len(dataor[dataor["Subject"] == "Math"])))
